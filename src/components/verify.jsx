      ...
      <div className="flex overflow-hidden flex-col bg-white rounded">
        ...
        <div className="flex flex-col self-center px-16 py-12 mt-10 max-w-full bg-white rounded-3xl border border-solid border-stone-300 w-[576px] max-md:px-5">
          ...
          <div className="flex gap-3 mt-2 max-md:mr-0.5">
            <div className="flex shrink-0 bg-white rounded-md border border-solid border-stone-300 h-[47px] w-[47px]" />
            <div className="flex shrink-0 bg-white rounded-md border border-solid border-stone-300 h-[47px] w-[47px]" />
            <div className="flex shrink-0 bg-white rounded-md border border-solid border-stone-300 h-[47px] w-[47px]" />
            <div className="flex shrink-0 bg-white rounded-md border border-solid border-stone-300 h-[47px] w-[47px]" />
            <div className="flex shrink-0 bg-white rounded-md border border-solid border-stone-300 h-[47px] w-[47px]" />
          ...
          <div className="overflow-hidden gap-2.5 self-stretch px-36 py-5 mt-16 text-base font-medium tracking-wider text-center text-white uppercase whitespace-nowrap bg-black rounded-md border border-black border-solid min-h-[56px] max-md:px-5 max-md:mt-10">
            Verify
          </div>
        </div>
        <div className="flex mt-72 w-full min-h-0 border border-red-500 border-dashed max-md:mt-10 max-md:max-w-full" />
      </div>
      <style jsx>{`
        builder-component {
