  ...
  return (
    <>
      <div className="flex overflow-hidden flex-col pb-44 bg-white rounded max-md:pb-24">
        ...
        <div className="flex flex-col self-center px-16 py-12 mt-10 max-w-full text-base bg-white rounded-3xl border border-solid border-stone-300 w-[576px] max-md:px-5">
          ...
          <div className="flex gap-5 justify-between px-4 py-4 mt-2 whitespace-nowrap bg-white rounded-md border border-solid border-stone-300 max-md:max-w-full">
            <div className="text-zinc-500">Enter</div>
            <div className="text-black">Show</div>
          </div>
          <div className="overflow-hidden gap-2.5 self-stretch px-36 py-5 mt-10 font-medium tracking-wider text-center text-white uppercase whitespace-nowrap bg-black rounded-md border border-black border-solid min-h-[56px] max-md:px-5">
            Login
          </div>
          ...
          <div className="flex gap-2.5 self-center mt-8 max-w-full w-[261px]">
            ...
            <div className="self-start font-medium tracking-wider text-black uppercase">
              Sign up
            </div>
          </div>
        </div>
        <div className="flex mt-28 w-full border border-red-500 border-dashed min-h-[1px] max-md:mt-10 max-md:max-w-full" />
      </div>
      <style jsx>{`
        builder-component {
